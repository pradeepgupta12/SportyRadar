...
// import { Link, useParams, useLocation } from 'react-router-dom';
// import SeoManager from '@/core/seo/SeoManager';
// import { getBlogBySlug } from "../../service/blogs.service.js";
...
//       // optional (if backend sends related)
...
//             <div className="flex items-center gap-3 mb-5 pb-5 border-b border-gray-200 dark:border-gray-700 flex-wrap">
//               <div className="flex items-center gap-1.5">
//                {post.authorImage?.src && (
//   <img
//     src={
//       post.authorImage.mode === "url"
//         ? post.authorImage.src
//         : `${import.meta.env.VITE_BACKEND_URL}${post.authorImage.src}`
//     }
